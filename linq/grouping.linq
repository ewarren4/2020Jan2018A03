...
//	 collections
//example 	tablerowinstance.childnavproperty.Count() count all the child
//	          records assiciated with the parent instance
...
//It is important to remember that once the smaller groups are created, ALL reporting
...
//where and orderby clauses can be executed against the group key component or any group field
