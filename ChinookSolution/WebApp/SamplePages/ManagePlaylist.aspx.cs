...
namespace Jan2018DemoWebsite.SamplePages
{
    public partial class ManagePlaylist : System.Web.UI.Page
    {
        ...
        protected void PlayListFetch_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                MessageUserControl.TryRun(() =>
                {
                    ...
                    PlayList.DataBind();
                },"PlayList","Manage your playlist"); //strings after coding block is for success "string","message"
            }
        }
        ...
        protected void MoveDown_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageUserControl.ShowInfo("Moving Tracks", "You must have a playlist showing. List either empty or you need to fetch your playlist.");
            }
            else
            {
                if(string.IsNullOrEmpty(PlaylistName.Text))
