...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <blockquote class="alert alert-info">
        ...
        The page will demostrate the use of the user control MessageUserControl as it pertains
        to ODS.
    </blockquote>
    <br />
    ...
    <%-- For the Delete to work on this ODS CRUD, you must include a parameter called DataKeyNames
         ...
         A change to layout/control on one template should be duplicated to other templates
    ...
    <asp:ListView ID="AlbumList" runat="server" DataSourceID="AlbumListODS"
        ...
        <EditItemTemplate>
            ...
            <asp:RegularExpressionValidator ID="RegExTitleBoxE" runat="server" 
        ...
        <InsertItemTemplate>
            ...
            <asp:RegularExpressionValidator ID="RegExTitleBoxI" runat="server" 
                ErrorMessage="Title is limited to 160 characters" Display="None"
                 ControlToValidate="TitleTextBoxI" ValidationGroup="IGroup"
                 ValidationExpression="^.{1,160}$">
            </asp:RegularExpressionValidator>
        ...
        <LayoutTemplate>
            <table runat="server">
                ...
                <tr runat="server">
                    <td runat="server" style="text-align: center; background-color: #c0c0c0; font-family: Verdana, Arial, Helvetica, sans-serif; color: #000000">
