            ...
            using (var context = new ChinookContext())
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        //   this technique can be used in your BLL and on your WebPage
                        //   to use this technique, you will collect your errors within
                ...
                //when you do an .Add(xxx) to an entity, the record
                ...
                //SaveChanges is what actually affects the database
                context.SaveChanges();
            }
        }//eom
